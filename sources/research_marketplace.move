module selora::research_marketplace {
    ...
    const PATIENT_SHARE_BPS:   u64 = 7500;  // 75.00%
    ...
    public struct Study has store {
        ...
        created_at:          u64,
        irb_expiry:          u64,
        patient_pool_mist:   Balance<IOTA>, // 75% — untouchable by Selora
        selora_fees_mist:    Balance<IOTA>, // 25% — Selora treasury only
    ...
    public fun fund_study(
        ...
        // Hard-coded split — immutable, visible on chain
        let patient_share = (total * PATIENT_SHARE_BPS) / BPS_DENOMINATOR;
        let selora_share  = total - patient_share;
    ...
    public fun get_split_preview(amount_mist: u64): (u64, u64) {
        let patient = (amount_mist * PATIENT_SHARE_BPS) / BPS_DENOMINATOR;
        (patient, amount_mist - patient)
    }
}